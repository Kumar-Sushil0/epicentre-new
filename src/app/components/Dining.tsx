  ...
  const items = [
    {
      ...
      description: "Locally sourced, organic vegetarian meals prepared with mindfulness. Light on the stomach, rich for the soul.",
      availability: "Daily",
    ...
    },
    {
      ...
      description: "A touch of zen culinary art. Fresh, vegetarian sushi rolls made in-house for a unique dining texture.",
    ...
    },
    {
      ...
      description: "Gather around our clay oven for rustic, thin-crust pizzas topped with garden-fresh herbs and cheese.",
