  ...
  return (
    <footer className="bg-earth-950 text-earth-300 border-t border-earth-800">
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-11 gap-12 lg:gap-6 mb-20 border-b border-earth-800/50 pb-20">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <span>View on Google Maps<br/>Bhigwan, Maharashtra</span>
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-earth-300/70 font-body">
                ...
                <li className="flex items-center gap-3 group">
                  ...
                  <a href="https://wa.me/919890322494" target="_blank" rel="noopener noreferrer" className="hover:text-earth-100 transition-colors">+91 98903 22494</a>
                </li>
                <li className="flex items-center gap-3 group">
                  <svg className="w-5 h-5 text-earth-400 group-hover:text-gold-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="#" className="hover:text-earth-100 transition-colors">@thesilentclub</a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  className="bg-earth-950 border border-earth-800 rounded px-4 py-3 text-sm text-earth-100 focus:outline-none focus:border-gold-500/50 flex-1 placeholder-gold-500/50 transition-colors"
                  placeholder="Your email address"
                  type="email"
                />
                <button className="bg-gold-500 hover:bg-gold-400 text-earth-950 px-6 py-3 rounded text-sm font-bold transition-all hover:shadow-lg hover:shadow-gold-500/20 whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
