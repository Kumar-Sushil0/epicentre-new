  ...
  return (
    <footer className="bg-earth-950 text-earth-300 border-t border-earth-800">
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-6 mb-20 border-b border-earth-800/50 pb-20">
          ...
          <div className="lg:col-span-2 lg:pl-4">
            ...
            <ul className="space-y-4 text-sm text-earth-300/70 font-body mt-6">
              <li className="flex items-center gap-3 group">
                <svg className="w-5 h-5 text-earth-400 group-hover:text-gold-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-3">
            <h4 className="text-earth-100 font-bold mb-3 text-sm tracking-wide uppercase">Join our newsletter</h4>
