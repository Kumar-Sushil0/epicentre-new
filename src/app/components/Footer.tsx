  ...
  return (
    <footer className="bg-earth-950 text-earth-300 py-16 border-t border-earth-700">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-5 gap-8 mb-16 border-b border-earth-800 pb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="mb-6 relative h-[60px] w-44">
              <Image
                src="/Untitled.png"
                alt="EPiCentre Logo"
                fill
            ...
            <div className="text-sm text-earth-300/60 font-body leading-relaxed space-y-3">
              <p>
                The Silent Club<br />
                Near Bird Sanctuary<br />
                Kumbhargaon, Bhigwan<br />
                Maharashtra - 413104
              </p>
              <a
                ...
                className="flex items-center gap-2 hover:text-gold-500 transition-colors w-fit"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-earth-300/60 font-body w-fit">
              ...
              <li className="w-fit">
                <Link className="hover:text-gold-500 transition-colors" href="/stories">
                  Our Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-earth-50 font-bold mb-6">Our Experiences</h3>
            <ul className="space-y-3 text-sm text-earth-300/60 font-body w-fit">
              <li className="w-fit">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-earth-300/60 font-body">
              ...
              <li className="flex items-center gap-2 mt-4">
                <a className="hover:text-gold-500 transition-colors flex items-center gap-2" href="#">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
