      ...
      <div className="max-w-[1280px] mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 ml-auto">
          ...
          >
            ...
            {/* Dropdown Menu */}
            <div
              className={`absolute top-full left-0 mt-2 w-48 bg-earth-900/95 backdrop-blur-md border border-earth-700 rounded-lg shadow-xl overflow-hidden transition-all duration-200 ${isExperiencesOpen ? "opacity-100 visible translate-y-0" : "opacity-0 invisible -translate-y-2"
                }`}
            >
              <Link
                href="/wellness"
