        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-5/12 relative">
            <div className="relative h-full min-h-[500px] w-full overflow-hidden rounded-2xl">
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-gold-500 hover:bg-gold-600 rounded-full flex items-center justify-center text-earth-950 transition-colors shadow-lg z-10"
              >
                <span className="material-symbols-outlined">chevron_left</span>
              </button>
              <button
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-gold-500 hover:bg-gold-600 rounded-full flex items-center justify-center text-earth-950 transition-colors shadow-lg z-10"
              >
