      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-xl">
            <h2 className="text-earth-50 text-3xl md:text-5xl font-bold mb-6">Raw & Real</h2>
            <p className="text-earth-50/70 font-body text-lg">
              Our structures do not dominate the landscape; they surrender to it. Built with local stone and bathed in natural light, the architecture is a lesson in humility.
            </p>
          </div>
