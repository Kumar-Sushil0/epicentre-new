        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-5/12">
            <div className="relative rounded-lg overflow-hidden aspect-3/4 shadow-2xl">
              <div 
                className="w-full h-full bg-cover bg-center contrast-125" 
                style={{
          ...
          <div className="w-full lg:w-7/12 space-y-8">
            ...
            <div className="space-y-4 text-earth-50/70 font-body text-base md:text-lg leading-relaxed">
              ...
              <p className="italic">why do capable people feel stuck inside lives they never consciously designed? Not because they lack motivation.</p>
