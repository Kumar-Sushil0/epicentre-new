  ...
  return (
    <section className="py-24 px-6 bg-earth-900 relative">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-16">
          <h2 className="text-gold-500 text-3xl md:text-4xl font-display" style={{ fontFamily: 'Trirong, serif' }}>Operating Principles</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Trirong, serif' }}>Designed Silence</h4>
          ...
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Trirong, serif' }}>Non-Performative Space</h4>
          ...
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Trirong, serif' }}>Environment-Led Change</h4>
