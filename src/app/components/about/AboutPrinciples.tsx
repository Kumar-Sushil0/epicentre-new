      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Outfit, sans-serif' }}>Designed Silence</h4>
          ...
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Outfit, sans-serif' }}>Non-Performative Space</h4>
          ...
          <div className="p-8 border border-earth-700 bg-earth-950/50">
            ...
            <h4 className="text-gold-500 font-bold mb-4" style={{ fontFamily: 'Outfit, sans-serif' }}>Environment-Led Change</h4>
