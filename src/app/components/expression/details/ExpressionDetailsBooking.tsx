...
const whatsappMessage = encodeURIComponent('Hey I find this interesting i would like to know more about the expression experiments');
...
export default function ExpressionDetailsBooking({
  ...
  const getPrice = () => {
    return accommodationType === 'dorm' ? '₹35,000' : '₹50,000';
  };
    ...
    <div className="w-full lg:w-[400px] flex-shrink-0">
      <div className="sticky top-24 bg-earth-800 rounded-xl border border-earth-700 shadow-2xl overflow-hidden">
        <div className="p-6 border-b border-earth-700 bg-earth-800/50">
          <h3 className="text-xl font-bold text-earth-50 mb-1">Book Your Experiment</h3>
