  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center p-4">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-20 flex flex-col items-center text-center gap-8 mt-16">
        <span className="text-gold-500 tracking-[0.2em] uppercase text-sm font-semibold">The Art of Being</span>
        ...
        <p className="text-earth-50/90 text-lg md:text-xl font-display font-light leading-relaxed max-w-2xl">
          True restoration is found in time spent alone without instruction. Rediscover the silence within yourself through unguided exploration.
        </p>
        <div className="mt-8">
