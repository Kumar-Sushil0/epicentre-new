...
export const blogPosts: Record<string, BlogPostDetail> = {
  "thinking-problem": {
    ...
    content: [
      ...
      "Endless. Frictionless. Crowded. Not with noise, with other people's clarity.",
      ...
      "But if you sit still long enough, really still, something strange happens. Nothing comes. Not yours.",
      ...
      "The world calls this efficiency. Access. Speed. Optimization.",
      ...
      "With everything you postponed: decisions, doubts, things that don't quite fit but you kept anyway.",
      ...
      "Because now you can't blame circumstance. You can't blame lack. You can't even distract yourself with ambition the same way.",
  ...
  "need-disgust": {
    ...
    content: [
      ...
      "Not because you like it. Because you've learned how to live with it.",
      ...
      "You adjust. You optimize. You add systems to support a life you don't even fully respect.",
      "That's the trap.",
      ...
      "They lower the standard. Rename it. Rationalize it. Call it balance. Call it realism. Call it maturity.",
      "But it's not.",
      ...
      "Not your goals. Your minimum.",
      "And minimums are dangerous.",
      "Because they don't announce themselves. They settle.",
      "Quietly. Until one day you look around and realize you've built a life you don't even question anymore.",
      ...
      "But underneath that, something stabilizes.",
  ...
  "dont-actually-know-what-you-want": {
    ...
    content: [
      ...
      "But familiarity is not truth. It's repetition.",
      ...
      "Less impressive. Less explainable. Less optimized.",
      ...
      "So instead, you start optimizing.",
  ...
  "always-performing-alone": {
    ...
    content: [
      ...
      "That's performance.",
      "And it's exhausting.",
      "Because you're never fully off.",
      ...
      "And over time, you internalize the audience.",
      ...
      "Until what's left isn't impressive. Isn't optimized. Isn't even fully clear.",
      "But it's real.",
  ...
  "breaking-promises-to-yourself": {
    ...
    content: [
      ...
      "Don't optimize it. Don't plan it.",
  ...
  "saying-yes-so-you-dont-commit": {
    ...
    content: [
      ...
      "It's a decision that no longer needs to be made. Again. And again. And again.",
  ...
  "updating-life-never-chose": {
    ...
    content: [
      ...
      "But based on what actually fits now.",
      "Cleanly. Without justification.",
      "That's authorship.",
      "Not rewriting everything.",
      "But refusing to keep continuing what was never consciously chosen.",
  ...
  "small-things-decide-your-life": {
    ...
    content: [
      ...
      "But attention doesn't work individually.",
      ...
      "Until you look up and realize you've been busy but not directed.",
      "That's the cost.",
      ...
      "And right now, too much is getting through.",
      "That's why everything feels scattered.",
      "Not because you lack control. Because you're not enforcing it.",
  ...
  "blaming-yourself-for-environment": {
    title: "You Keep Blaming Yourself for What Your Environment Is Doing",
    subtitle: "Behavior follows setup more than intention.",
    category: "Decision & Clarity",
    author: "The Silent Club",
    date: "2026",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBzQUBgomUJe6e1OB_6dmTVcgR_GYt5k-UgoretbmfZ_izouiCOaK8YYEWLDt_QTV_ISyTECnULI_O5W2HYPqj6w163bSvDPTOBZHjRl7FljH8xAlUWQIAfo5Eosj0EPZTfwiMtkXcjRL7RThN1FokJa4gSqWamw681YNKmVWdMcKtTZpKktdALEho3axfgg38XvTVTyHnF8634k552ETsVCipetwOV8NQ9ujUeRJusTOeygeyE16mtVKBxnTDmtPIEduKGAtXfTURb",
    content: [
      ...
      "And every one of those is shaping your behavior.",
      "Before you even act.",
      "That's the part you ignore.",
      "You walk into the same setup every day and expect different behavior.",
      "Then blame yourself when it doesn't happen.",
      "That's not failure. That's design.",
      "Because behavior doesn't come from intention.",
      ...
      "Because what surrounds you is stronger than what you intend.",
      ...
      "Structure is.",
      "Because the right environment makes the right behavior natural.",
      "Not forced.",
  ...
  "meaning-before-seen-enough": {
    ...
    content: [
      ...
      "You don't stay with it. You translate it.",
      "Immediately.",
      ...
      "It forms.",
      "Over time.",
      "Through noticing, sitting, returning.",
      "But you skip all that.",
      ...
      "That's why you keep searching. Again. And again.",
      ...
      "And spend their lives living inside meanings they never actually saw for themselves.",
