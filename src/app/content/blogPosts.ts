...
export const blogPosts: Record<string, BlogPostDetail> = {
  ...
  "clarity-subtraction": {
    ...
    content: [
      ...
      "More advice. More opinions. More frameworks. More conversations.",
      "Uncertainty feels like missing information. So they accumulate.",
      "But accumulation rarely resolves indecision. It multiplies variables.",
      "Most big questions are not unsolved because they lack data. They are unsolved because they are crowded.",
      "Crowded by expectations. Crowded by fear of consequence. Crowded by imagined reactions. Crowded by inherited identity.",
      "When everything speaks at once, clarity cannot surface.",
      "Clarity requires quiet space around the question.",
      "At The Silent Club, people often arrive with complex dilemmas. Career transitions. Relational shifts. Creative redirections. Exit decisions.",
      "The instinct is to analyze harder. But what often happens instead is simpler.",
      "When stimulation drops, external input reduces. When input reduces, comparison reduces. When comparison reduces, noise reduces.",
      "And when noise reduces, something remains.",
      "Usually, the answer was already present. It was just buried under negotiation.",
      "Most clarity does not arrive as a revelation. It arrives as elimination.",
      "'That no longer matters.' 'That is not mine to carry.' 'That option was never aligned.' 'That fear is imagined.'",
      "Nothing new is added. Something false is removed.",
      "Subtraction stabilizes direction.",
      "Modern environments reward addition. Add credentials. Add strategies. Add validation.",
      "But clarity behaves differently. It sharpens when variables decrease.",
      "The Silent Club does not provide answers. It reduces interference.",
      "And in that reduction, decisions become quieter — but firmer.",
      "Clarity is rarely about discovering something new. It is about removing what does not belong."
    ]
  },
  "decisions-delayed": {
    ...
    content: [
      ...
      "Changing careers. Leaving a city. Ending a partnership. Starting something new.",
      "The language used is usually complexity. 'It's complicated.' 'There are too many factors.' 'I'm still thinking.'",
      "But when attention stabilizes, something becomes visible.",
      "The decision itself is often clear. What feels unclear is the consequence.",
      "Most large decisions are not cognitively confusing. They are emotionally expensive.",
      "They involve loss. Loss of identity. Loss of familiarity. Loss of status. Loss of certainty.",
      "The mind postpones what the body already senses.",
      "Not because the path is invisible. Because the cost is visible.",
      "In high-stimulation environments, postponement becomes easy. There is always another task. Another distraction. Another reason to delay clarity.",
      "Noise protects indecision. Silence removes that protection.",
      "When external input drops, the underlying question surfaces without buffer.",
      "In that state, many people notice something quiet but firm: They already know.",
      "The delay was not confusion. It was negotiation.",
      "Negotiation with fear. Negotiation with expectation. Negotiation with imagined outcomes.",
      "The Silent Club does not pressure decisions. It does not accelerate them.",
      "It simply reduces interference long enough for avoidance to become visible.",
      "When avoidance becomes visible, it loses its invisibility.",
      "And once visible, decisions tend to reorganize themselves. Not dramatically. But steadily.",
      "The difficulty was rarely the answer. It was the consequence.",
      "And consequence feels heavier when witnessed clearly.",
      "Most people wait for certainty. Clarity is often enough."
    ]
  },
  "silence-reveals": {
    ...
    content: [
      ...
      "But silence does not manufacture change. It removes interference.",
      "Most environments shape behavior continuously. They trigger roles. Reward performance. Demand responsiveness.",
      "In that cycle, identity becomes reactive. Decisions become negotiated externally. Direction becomes conditional.",
      "Silence interrupts that loop.",
      "When stimulus reduces, attention stabilizes. When attention stabilizes, patterns surface.",
      "Not new patterns. Existing ones.",
      "Your defaults. Your avoidance. Your preferences. Your fears. Your unfinished thoughts.",
      "Nothing is added. There is no instruction. No teaching. No imposed interpretation.",
      "The environment simply holds.",
      "In that holding, something becomes clear: Who you are when not prompted. Who you are when not performing. Who you are when no one is watching.",
      "The Tree House does not change you. The Dark Room does not change you. The Design Dome does not change you. The Entrance does not change you.",
      "They reduce external noise long enough for internal structure to become visible.",
      "Most change begins not with addition, but recognition. Recognition reorganizes behavior naturally.",
      "If a decision surfaces clearly, action follows. If a pattern becomes obvious, adjustment follows.",
      "Not because you were transformed. Because you saw yourself accurately.",
      "Silence is not an escape. It is contrast.",
      "And contrast reveals form.",
      "You leave with the same name. But if you were attentive, you leave with sharper authorship.",
      "The Silent Club does not aim to change you. It creates conditions where you can see what is already there.",
