...
export const CATS: Record<string, Cat> = {
  "Deep Work": {
    ...
    items: [
      ...
      { name: "Morning Pages", icon: "wb_sunny" },
  ...
  "Quiet Exploration": {
    ...
    items: [
      { name: "Dawn Watch", icon: "wb_twilight" },
      { name: "Bird Walking", icon: "directions_walk" },
      { name: "Forest Walk", icon: "forest" },
      { name: "Kayaking", icon: "kayaking" },
      { name: "Bird Watching Boat", icon: "sailing" },
      { name: "Animal Safari", icon: "pets" },
    ],
  },
  "Body Reset": {
    ...
    items: [
      ...
      { name: "Contrast Therapy", icon: "thermostat" },
  ...
  "Making": {
    ...
    items: [
      ...
      { name: "Clay Work", icon: "category" },
      { name: "Origami", icon: "interests" },
      { name: "Facial", icon: "face" },
      { name: "Cooking Solo", icon: "cooking" },
    ],
  },
  "Shared Silence": {
    color: "#fca5a5", bg: "rgba(239,68,68,.12)",
    items: [
      { name: "Silent Carrom", icon: "casino" },
      { name: "Silent Chess", icon: "chess" },
      { name: "Silent Jenga", icon: "view_column" },
      { name: "Walking Alongside", icon: "group" },
      { name: "Shared Dinner", icon: "dinner_dining" },
      { name: "Cooking Together", icon: "restaurant" },
    ],
  },
  "Subtraction": {
    color: "#c4b5fd", bg: "rgba(139,92,246,.12)",
    items: [
      { name: "Doing Nothing", icon: "hourglass_empty" },
      ...
      { name: "Fire Sitting", icon: "local_fire_department" },
    ],
  },
};
