...
export default function DiningPage() {
  ...
  return (
    <div className="relative min-h-screen">
                ...
                >
                  <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                      <h3 className="text-2xl font-bold mb-4">Dining {index + 1}</h3>
      ...
      {/* Dining 02 Section - Opposite Colors */}
      <section className="w-full bg-white">
        <div className="w-full">
              ...
              {Array.from({ length: 3 }).map((_, index) => (
                ...
                >
                  <div className="flip-card-inner">
                    ...
                    {/* Back Side - Information */}
                    <div className="flip-card-back">
                      <h3 className="text-2xl font-bold mb-4">Dining {index + 4}</h3>
                      <p className="text-sm text-center">
                        {loremIpsum.substring(0, 100)}...
                      </p>
                    </div>
      ...
      {/* Dining 03 Section - Black Background */}
      <section className="w-full bg-white">
        <div className="w-full">
          <div className="bg-black p-12">
            {/* Heading */}
              ...
              {Array.from({ length: 3 }).map((_, index) => (
                ...
                >
                  <div className="flip-card-inner">
                    ...
                    {/* Back Side - Information */}
                    <div className="flip-card-back">
                      <h3 className="text-2xl font-bold mb-4">Dining {index + 7}</h3>
                      <p className="text-sm text-center">
                        {loremIpsum.substring(0, 100)}...
                      </p>
                    </div>
      ...
      {/* Dining 04 Section - White Background */}
      <section className="w-full bg-white">
        <div className="w-full">
          <div className="bg-white p-12">
            {/* Heading */}
              ...
              {Array.from({ length: 3 }).map((_, index) => (
                ...
                >
                  <div className="flip-card-inner">
                    ...
                    {/* Back Side - Information */}
                    <div className="flip-card-back">
                      <h3 className="text-2xl font-bold mb-4">Dining {index + 10}</h3>
                      <p className="text-sm text-center">
                        {loremIpsum.substring(0, 100)}...
                      </p>
                    </div>
