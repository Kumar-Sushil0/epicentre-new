  ...
  return (
    <style dangerouslySetInnerHTML={{__html: `
      ...
      *{box-sizing:border-box} body{margin:0;background:var(--bg);color:var(--gold-pale);font-family:var(--sans);font-weight:300}
      ...
      .nav-cta{font-size:.65rem;letter-spacing:.16em;text-transform:uppercase;color:var(--bg);background:var(--gold);padding:9px 22px;border:none;font-weight:bold}
      ...
      .hero-content{position:relative;z-index:2;padding:clamp(48px,6vw,80px) var(--g);display:flex;flex-direction:column;gap:6px}
      ...
      .hero-headline{font-family:var(--serif);font-size:clamp(2.4rem,6vw,6rem);font-weight:700;color:var(--gold-pale);line-height:.92;margin:0 0 28px}
      .hero-headline em{display:block;margin-top:16px;color:var(--gold);font-style:italic}
      .hero-sub{font-size:.875rem;color:var(--text-2);line-height:2;font-family:var(--sans)}
      ...
      .intro-label{font-family:var(--serif);font-size:clamp(2.5rem,4vw,4rem);font-weight:300;color:var(--gold-pale);margin-bottom:16px}
      ...
      .number-item{background:var(--bg-2);padding:28px 24px;text-align:center}.number-val{font-family:var(--serif);font-size:2.4rem;color:var(--gold)}
      .number-label{font-size:.875rem;font-weight:400;color:var(--text-2);margin-top:4px}
      .cat-section{border-bottom:1px solid var(--rule)} .cat-header{padding:clamp(40px,5vw,56px) var(--g);display:grid;grid-template-columns:1fr 1.8fr;gap:0 100px;align-items:center;border-bottom:1px solid var(--rule)}
      ...
      .cat-toggle{position:absolute;right:var(--g);top:50%;transform:translateY(-50%);font-size:2rem;color:var(--gold-dim);transition:transform .25s ease;line-height:1}
      ...
      .cat-num-title{display:flex;align-items:center;gap:12px}
      .cat-num{font-family:var(--serif);font-size:clamp(1.5rem,3vw,2.7rem);font-weight:600;color:var(--text-3);line-height:1}
      .cat-sep{font-family:var(--serif);font-size:clamp(1.5rem,3vw,2.7rem);font-weight:600;color:var(--text-3);line-height:1}
      .cat-title{font-family:var(--serif);font-size:clamp(1.5rem,3vw,2.7rem);line-height:1}
      .cat-desc{font-size:.875rem;line-height:1.85;color:var(--text-2);font-family:var(--sans)}
      ...
      .cta-headline{font-family:var(--serif);font-size:clamp(2rem,4vw,4rem);line-height:1.15;margin-bottom:36px}.btn-gold{background:var(--gold);color:var(--bg);font-size:.68rem;letter-spacing:.18em;text-transform:uppercase;padding:14px 36px;border:none;font-weight:bold}
      .cta-sub{margin-top:16px;font-family:var(--serif);font-style:italic;font-size:1.05rem;color:var(--text-3)}
