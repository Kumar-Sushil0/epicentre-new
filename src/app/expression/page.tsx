...
export default function ExpressionPage() {
  const pillars = [
    {
      title: "Language Play",
      description: "Experimenting with the structure and sound of words. Break free from grammatical constraints to find new rhythms.",
      image:
    ...
    {
      title: "Finding Voice",
      description: "Discovering the authentic timber of your personal narrative. Vocal exercises designed to unlock your inner resonance.",
      image:
    ...
    },
    {
      ...
      description: "Channeling thoughts through the rhythm of keys. Focused sessions for drafting, editing, and finding flow.",
      image:
