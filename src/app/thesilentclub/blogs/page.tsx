      ...
      <footer className="footer">
        <div className="footer-top">
          ...
          <div className="footer-col">
            ...
            <a className="footer-link" href="/thesilentclub/home">Home</a>
            <a className="footer-link" href="/thesilentclub/about">About</a>
            <a className="footer-link" href="/thesilentclub/estate">The Estate</a>
            <a className="footer-link" href="/thesilentclub/blogs">Journal</a>
            <a className="footer-link" href="/thesilentclub/faq">FAQ</a>
          </div>
          <div className="footer-col">
