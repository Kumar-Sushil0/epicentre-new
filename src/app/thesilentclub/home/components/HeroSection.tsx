export function HeroSection({ onOpenModal }: { onOpenModal: () => void }) {
  return (
    <section className="relative flex min-h-[calc(100vh-56px)] flex-col overflow-hidden border-b border-[#2a1f17]">
      ...
      <div className="relative z-10 mt-auto flex flex-col gap-6 px-5 py-10 md:px-[56px] md:py-12">
        ...
        <h1 className="font-serif text-4xl leading-[0.92] md:text-6xl lg:text-8xl">
        ...
        <p className="max-w-xl text-sm leading-8 text-[#b09070]">
          ...
          luxury in modern life is uninterrupted time with your own{" "}
          <em className="underline">self</em>.
        </p>
        <div className="flex max-w-xs flex-col gap-2">
          ...
          <a href="/daydesigner" className="border border-[#3a2a1f] bg-[#0f0b08] px-6 py-3 text-[11px] font-bold uppercase tracking-[0.16em] text-[#b09070] text-center">
